...
//     return (
//       <Grid container sx={styles.weekDaysHeader}>
//         {weekDays.map((day, index) => (
//           <Grid item xs={12/7} key={index} sx={styles.weekDayCell}>
//             <Typography 
//               variant="subtitle2" 
//               sx={`${styles.weekDayText} ${index === 6 ? styles.sabbathDay : ''}`}
//             >
//               {day}
//             </Typography>
//           </Grid>
...
//                 {day.events.length > 3 && (
//                   <Typography variant="caption" sx={styles.moreEventsText}>
