...
// import { clearCancellationError } from '../../../store/lessonsCancelation/lessonsCancelationSlice';
...
//     // פונקציה לבדיקה האם שיעור בוטל בתאריך מסוים
...
//     // פונקציה לבדיקה האם יש ביטולים לתאריך מסוים (לכל הקבוצות)
...
//     // פונקציה לקבלת כל הביטולים של קבוצה מסוימת
//     const getCancellationsForGroup = (groupId) => {
//         return cancellations.filter(cancellation => cancellation.groupId === groupId);
//     };

//     // בדיקה האם כבר קיים ביטול לקבוצה ותאריך מסוימים
...
//         // בדיקה האם כבר קיים ביטול לקבוצה ותאריך זה
...
//     // אם הדיאלוג לא פתוח, לא נציג כלום
//     if (!open) {
//         return null;
//     }
...
//                         <Button
//                             onClick={() => {
//                                 if (deleteDialog.cancellationId) {
//                                     handleDeleteCancellation(deleteDialog.cancellationId);
//                                 }
//                             }}
//                             variant="contained"
//                             color="error"
...
//     const dispatch = useDispatch();
//     const { cancellations, loading, error } = useSelector(state => state.lessonCancellations || {});
